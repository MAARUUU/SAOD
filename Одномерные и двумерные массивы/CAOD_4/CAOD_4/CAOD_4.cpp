...
//Задано множество точек на плоскости. Найти все четверки точек, являющихся
//вершинами квадратов.
...
void main()
{
	...
	for (int n = 0; n < NextSquare; n++)
	{
		...
		fout << "квадрат - ";
		fout <<"("<< b[n].p1.x << ";" << b[n].p1.y << "), (" << b[n].p2.x << ";" << b[n].p2.y << "), (" << b[n].p3.x << ";" << b[n].p3.y << "), (" << b[n].p4.x << ";" << b[n].p4.y <<")"<< endl;
	}
	fout << "" << endl << endl;
